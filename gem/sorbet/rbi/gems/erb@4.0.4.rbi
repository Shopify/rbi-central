...
class ERB
  ...
  #   end
  #
  # source://erb//erb.rb#482
  def def_module(methodname = T.unsafe(nil)); end

  # The encoding to eval
  #
  # source://erb//erb.rb#370
  def encoding; end

  # The optional _filename_ argument passed to Kernel#eval when the ERB code
  # is run
  #
  # source://erb//erb.rb#374
  def filename; end
  ...
  #   #   from file.erb:4
  #
  # source://erb//erb.rb#395
  def location=(_arg0); end

  # Creates a new compiler for ERB.  See ERB::Compiler.new for details
  #
  # source://erb//erb.rb#362
  ...
  # code evaluation.
  #
  # source://erb//erb.rb#425
  def result(b = T.unsafe(nil)); end

  # Render a template on a new toplevel binding with local variables specified
  # by a Hash object.
  #
  # source://erb//erb.rb#434
  def result_with_hash(hash); end

  # Generate results and print them. (see ERB#result)
  #
  # source://erb//erb.rb#413
  ...
  #
  # source://erb//erb.rb#405
  def set_eoutvar(compiler, eoutvar = T.unsafe(nil)); end

  # The Ruby code generated by ERB
  #
  # source://erb//erb.rb#367
  def src; end
...
class ERB::Compiler
  ...
  #
  # source://erb//erb/compiler.rb#427
  def initialize(trim_mode); end

  # source://erb//erb/compiler.rb#309
  def add_insert_cmd(out, content); end

  # source://erb//erb/compiler.rb#305
  ...
  # @raise [ArgumentError]
  #
  # source://erb//erb/compiler.rb#315
  def compile(s); end

  # source://erb//erb/compiler.rb#375
  def compile_content(stag, out); end

  # source://erb//erb/compiler.rb#362
  def compile_etag(etag, out, scanner); end

  # source://erb//erb/compiler.rb#338
  def compile_stag(stag, out, scanner); end

  # The command to handle text that is inserted prior to a newline
  #
  # source://erb//erb/compiler.rb#440
  def insert_cmd; end
  ...
  # source://erb//erb/compiler.rb#421
  def make_scanner(src); end

  # Returns the value of attribute percent.
  #
  # source://erb//erb/compiler.rb#434
  def percent; end

  # An array of commands appended to compiled code
  #
  # source://erb//erb/compiler.rb#446
  def post_cmd; end
  ...
  #
  # source://erb//erb/compiler.rb#443
  def pre_cmd; end
  ...
  # source://erb//erb/compiler.rb#392
  def prepare_trim_mode(mode); end

  # The command to handle text that ends with a newline
  #
  # source://erb//erb/compiler.rb#437
  def put_cmd; end
  ...
  #
  # source://erb//erb/compiler.rb#451
  def content; end
  ...
  # source://erb//erb/compiler.rb#453
  def detect_magic_comment(s, enc = T.unsafe(nil)); end

  # source://erb//erb/compiler.rb#469
...
class ERB::Compiler::Buffer
  ...
  #
  # source://erb//erb/compiler.rb#273
  def initialize(compiler, enc = T.unsafe(nil), frozen = T.unsafe(nil)); end

  # source://erb//erb/compiler.rb#295
  def close; end

  # source://erb//erb/compiler.rb#289
  def cr; end

  # source://erb//erb/compiler.rb#285
  def push(cmd); end

  # Returns the value of attribute script.
  #
  # source://erb//erb/compiler.rb#283
  def script; end
end

class ERB::Compiler::ExplicitScanner < ::ERB::Compiler::Scanner
  # source://erb//erb/compiler.rb#249
  def scan; end
end
...
class ERB::Compiler::PercentLine
  ...
  #
  # source://erb//erb/compiler.rb#75
  def initialize(str); end

  # Returns the value of attribute value.
  #
  # source://erb//erb/compiler.rb#79
  def to_s; end

  # Returns the value of attribute value.
  #
  # source://erb//erb/compiler.rb#78
  def value; end
end
...
class ERB::Compiler::Scanner
  ...
  #
  # source://erb//erb/compiler.rb#102
  def initialize(src, trim_mode, percent); end

  # Returns the value of attribute etags.
  #
  # source://erb//erb/compiler.rb#109
  def etags; end

  # source://erb//erb/compiler.rb#111
  def scan; end

  # Returns the value of attribute stag.
  #
  # source://erb//erb/compiler.rb#108
  def stag; end
...
class ERB::Compiler::SimpleScanner < ::ERB::Compiler::Scanner
  # source://erb//erb/compiler.rb#235
  def scan; end
end
...
class ERB::Compiler::TrimScanner < ::ERB::Compiler::Scanner
  ...
  #
  # source://erb//erb/compiler.rb#115
  def initialize(src, trim_mode, percent); end

  # source://erb//erb/compiler.rb#204
  def explicit_trim_line(line); end

  # @return [Boolean]
  #
  # source://erb//erb/compiler.rb#223
  def is_erb_stag?(s); end

  # source://erb//erb/compiler.rb#146
  def percent_line(line, &block); end

  # source://erb//erb/compiler.rb#134
  def scan(&block); end

  # source://erb//erb/compiler.rb#159
  def scan_line(line); end

  # source://erb//erb/compiler.rb#168
  def trim_line1(line); end

  # source://erb//erb/compiler.rb#182
...
module ERB::DefMethod
  ...
  #
  # source://erb//erb/def_method.rb#36
  ...
  class << self
    ...
    # object or eRuby file
    #
    # source://erb//erb/def_method.rb#46
    def def_erb_method(methodname, erb_or_fname); end
  end
end
...
module ERB::Util
  ...
  #   Programming%20Ruby%3A%20%20The%20Pragmatic%20Programmer%27s%20Guide
  #
  # source://erb//erb/util.rb#57
  def url_encode(s); end

  class << self
    # source://erb//erb/util.rb#43
    def h(_arg0); end

    # source://erb//erb/util.rb#41
