...
class ERB::Compiler
  ...
  # trim modes.
  #
  # pkg:gem/erb#erb/compiler.rb:433
  def initialize(trim_mode); end

  # pkg:gem/erb#erb/compiler.rb:315
  def add_insert_cmd(out, content); end

  # pkg:gem/erb#erb/compiler.rb:311
  def add_put_cmd(out, content); end

  # Compiles an ERB template into Ruby code.  Returns an array of the code
  # and encoding like ["code", Encoding].
  #
  # pkg:gem/erb#erb/compiler.rb:321
  def compile(s); end

  # pkg:gem/erb#erb/compiler.rb:381
  def compile_content(stag, out); end

  # pkg:gem/erb#erb/compiler.rb:368
  def compile_etag(etag, out, scanner); end

  # pkg:gem/erb#erb/compiler.rb:344
  def compile_stag(stag, out, scanner); end

  # The command to handle text that is inserted prior to a newline
  #
  # pkg:gem/erb#erb/compiler.rb:446
  def insert_cmd; end
  ...
  # pkg:gem/erb#erb/compiler.rb:427
  def make_scanner(src); end

  # pkg:gem/erb#erb/compiler.rb:440
  def percent; end

  # An array of commands appended to compiled code
  #
  # pkg:gem/erb#erb/compiler.rb:452
  def post_cmd; end
  ...
  #
  # pkg:gem/erb#erb/compiler.rb:449
  def pre_cmd; end
  ...
  # pkg:gem/erb#erb/compiler.rb:398
  def prepare_trim_mode(mode); end

  # The command to handle text that ends with a newline
  #
  # pkg:gem/erb#erb/compiler.rb:443
  def put_cmd; end
  ...
  #
  # pkg:gem/erb#erb/compiler.rb:457
  def content; end
  ...
  # pkg:gem/erb#erb/compiler.rb:459
  def detect_magic_comment(s, enc = T.unsafe(nil)); end

  # pkg:gem/erb#erb/compiler.rb:484
  def warn_invalid_trim_mode(mode, uplevel:); end
end

class ERB::Compiler::Buffer
  # pkg:gem/erb#erb/compiler.rb:279
  def initialize(compiler, enc = T.unsafe(nil), frozen = T.unsafe(nil)); end

  # pkg:gem/erb#erb/compiler.rb:301
  def close; end

  # pkg:gem/erb#erb/compiler.rb:295
  def cr; end

  # pkg:gem/erb#erb/compiler.rb:291
  def push(cmd); end

  # pkg:gem/erb#erb/compiler.rb:289
  def script; end
end

class ERB::Compiler::ExplicitScanner < ::ERB::Compiler::Scanner
  # pkg:gem/erb#erb/compiler.rb:255
  def scan; end
end

class ERB::Compiler::PercentLine
  # pkg:gem/erb#erb/compiler.rb:75
  def initialize(str); end

  # pkg:gem/erb#erb/compiler.rb:79
  def to_s; end

  # pkg:gem/erb#erb/compiler.rb:78
  def value; end
end

class ERB::Compiler::Scanner
  # pkg:gem/erb#erb/compiler.rb:108
  def initialize(src, trim_mode, percent); end

  # pkg:gem/erb#erb/compiler.rb:115
  def etags; end

  # pkg:gem/erb#erb/compiler.rb:117
  def scan; end

  # pkg:gem/erb#erb/compiler.rb:114
  def stag; end
...
module ERB::DefMethod
  ...
  #
  # pkg:gem/erb#erb/def_method.rb:36
  def def_erb_method(methodname, erb_or_fname); end

  class << self
    # pkg:gem/erb#erb/def_method.rb:46
    def def_erb_method(methodname, erb_or_fname); end
  end
end
...
module ERB::Util
  ...
  # pkg:gem/erb#erb/util.rb:48
  def h(_arg0); end

  # pkg:gem/erb#erb/util.rb:74
  def u(s); end
  ...
  # cgi.gem <= v0.3.2
  #
  # pkg:gem/erb#erb/util.rb:64
  def url_encode(s); end

  class << self
    # pkg:gem/erb#erb/util.rb:49
    def h(_arg0); end

    # pkg:gem/erb#erb/util.rb:47
    def html_escape(_arg0); end

    # pkg:gem/erb#erb/util.rb:75
    def u(s); end

    # pkg:gem/erb#erb/util.rb:76
    def url_encode(s); end
  end
end
