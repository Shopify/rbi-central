...
module BEncode
  ...
  sig { params(obj: T.any(T::Array[T.untyped], Integer, T::Hash[T.untyped, T.untyped], String)).returns(String) }
  ...
  sig { params(str: String, opts: { ignore_trailing_junk: T::Boolean }).returns(T.untyped) }
  ...
  # @option (see .load)
  # @return (see .load)
  sig { params(path: String, opts: { ignore_trailing_junk: T::Boolean }).returns(T.untyped) }
