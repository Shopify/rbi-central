...
class CronParser
  ...
  sig { params(elem: String, allowed_range: T::Range[Integer]).returns([T::Set[Integer], T::Array[Integer], String]) }
  ...
  sig { params(current: Integer, allowed: T::Array[Integer], dir: Symbol).returns(T.nilable(Integer)) }
