...
sig { params(args: String).returns(Pathname) }
...
module FakeFS
  class << self
    ...
    sig { params(io_mocks: T::Boolean).void }
    def activate!(io_mocks: false); end
  ...
  class File < StringIO
    ...
    class << self
      sig { params(one_path: String, another_path: String).returns(T::Boolean) }
      def identical?(one_path, another_path); end

      # Assume nothing is sticky.
      sig { params(_path: String).returns(FalseClass) }
    ...
    sig { params(path: String).returns(T.nilable(Time)) }
    ...
    sig { params(atime: Time, mtime: Time, paths:String).returns(T.nilable(Integer)) }
    ...
    sig { params(file_name: String, dir_string: String).returns(String) }
    def self.expand_path(file_name, dir_string = FileSystem.current_dir.to_s); end

    sig { params(args: String).returns(String) }
    def self.basename(*args); end

    sig { params(args: T.untyped).returns(String) }
    def self.dirname(*args); end

    # TODO: return is a symlink.target ??
    sig { params(path: String).returns(T.untyped) }
    def self.readlink(path); end

    sig { params(path: String, args: T.untyped).returns(T.nilable(String)) }
